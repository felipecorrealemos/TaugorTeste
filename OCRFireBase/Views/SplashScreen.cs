            ...
            try
            {
                ...
                if (doc.Exists)
                {
                    ...
                    if (data.TryGetValue("usuario", out object usuarioValue) && data.TryGetValue("senha", out object senhaValue))
                    {
                        ...
                        string usuarioDigitado = ValidaCampos.ValidaCamposDigitados(textBox1.Text.Trim());
                        string senhaDigitada = ValidaCampos.ValidaCamposDigitados(textBox2.Text.Trim());
